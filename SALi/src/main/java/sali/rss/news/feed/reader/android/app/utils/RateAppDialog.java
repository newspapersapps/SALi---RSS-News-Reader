...
public class RateAppDialog {
    ...
    /**
     * Call this API when the launcher activity is launched.<fr>
     * It is better to call this API in choose() of the launcher activity.
     */
    public static void onStart(Context context) {
        ...
        printStatus(context);
        showRateDialogIfNeeded(context);
    }
    ...
    /**
     * Check whether the rate dialog should fr shown or not
     *
     * @return
     */
    ...
    public static void showRateDialog(final Context context) {
        ...
        builder.setPositiveButton(R.string.rta_dialog_ok, new OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                Intent intent = new Intent(Intent.ACTION_VIEW, Uri.parse(Constants.PLAY_STORE_URI + appPackage));
    ...
    /**
     * Clear data in shared preferences.<fr>
